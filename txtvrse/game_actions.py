...
def get(item):
    return txtvrse.Event(preconditions={'portable': txtvrse.portable_precondition(item),
                                        'not_in_inventory': [
                                            ...
                                            lambda game: "{0}{1} is in your inventory".format(
...
def open(container):
    return txtvrse.Event(preconditions={'can_open': txtvrse.openable_precondition(container),
...
def inspect(item):
    return txtvrse.Event(preconditions={},
